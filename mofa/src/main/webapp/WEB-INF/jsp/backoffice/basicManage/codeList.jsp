            ...
            <div class="Swrap tableArea">
                <div class="code_width">
                    ...
                    <div class="code_text margin-top10">
                        <span>
                            <input type="text" size="14" name="searchKeyword" id="searchKeyword" value="${searchVO.searchKeyword}" class="nameB ssg_input" placeholder="">
                            <a href="javascript:search_form()" class="redBtn"><spring:message code="button.inquire" /></a>
                        </span>
                        <span>
                            <form:input path="codeId" id="codeId" title="코드" size="14" class="nameB ssg_input"/>
                            <a href="javascript:fn_idCheck('Basic');" class="redBtn">
                            <spring:message code="page.common.btn.UniCheck" />
                            </a>
                        </span>
                        <span>
                            <form:input path="codeIdNm" id="codeIdNm" class="nameB ssg_input" title="코드명" size="14" />
  ...
  <script type="text/javascript">
    ...
    <script type="text/javascript">
        ...
        function fn_RightView(result){
        	...
        	didDetailHtm = "<table class='margin-top30 backTable'><thead><tr><th>분류명</th><th>기타</th><th>수정 | 삭제</th></tr></thead><tbody>";
			if (result != null) {
				...
				if (result.cmDetailLst != null) {
					for (var i=0; i<result.cmDetailLst.length; i++) {
						...
						didDetailHtm += "<tr><td>"+ obj.codeNm  +"</td>"
						                      +   "<td>&nbsp;"+ obj.codeDc  +"</td>"
						                      +   "<td>&nbsp;<a href='javascript:del_code(&#39;"+ obj.code  +"&#39;,&#39;"+ $("#codeId").val()  +"&#39;, &#39;Edt&#39;)' class='grayBtn'>수정</a>"
				...
				didDetailHtm += "<span><a href='javascript:codeDetail_insert(&#39;Ins&#39;,&#39;0&#39;);' class='redBtn' id='subBtnTxt'>등록</a></span>";
				didDetailHtm += "</div>";	 
