...
import aten.com.backoffice.sym.monter.mapper.DetailPageInfoManageMapper;
...
import aten.com.backoffice.util.web.service.FileUtil;
import aten.com.backoffice.uat.vo.UniUtilInfo;
import aten.com.backoffice.uat.service.UniUtilManageService;

@Service
public class DetailPageInfoManageServiceImpl extends EgovAbstractServiceImpl implements DetailPageInfoManageService {

	
	private static final Logger LOGGER = LoggerFactory.getLogger(DetailPageInfoManageServiceImpl.class);
	...
	@Autowired
	private DetailPageInfoManageMapper detailMapper;
	...
	@Override
	public ModelAndView selectDetailPageInfoManageListByPagination(DetailPageInfoVO searchVO) throws Exception {
		// TODO Auto-generated method stub
		
		ModelAndView model = new ModelAndView(Globals.JSONVIEW);
		try{
			
			List<Map<String, Object>> detailInfo = detailMapper.selectDetailPageInfoManageListByPagination(searchVO);
			
			model.addObject("detailInfo", detailInfo); 
			model.addObject("totcnt", detailInfo.get(0).get("total_record_count").toString());
			// 여기 부분 나중에 수정 하기 
			model.addObject("totTime", detailMapper.selectDetailSumTime(searchVO.getDisplaySeq()));
	...
	@Override
	public List<Map<String, Object>> selectDetailPageInfoManageListByContent(
			DetailPageInfoVO searchVO) throws Exception {
		// TODO Auto-generated method stub
	...
	@Override
	public ModelAndView deleteDetailPageInfoManage(DetailPageInfo vo) throws Exception {
		// TODO Auto-generated method stub
	...
	public int updateDetailTimeChangeManage(DetailPageInfo vo) throws Exception {
		...
		try{
			...
			LOGGER.error("updateDetailTimeChangeManage ERROR:" + e.toString());
			ret = -1;
		}
	...
	public int updateDetailSortOrderInfoManage(DetailPageInfoVO vo) throws Exception {
		...
		try{
			...
			LOGGER.error("updateDetailSortOrderInfoManage ERROR:" + e.toString());
			ret = -1;
		}
	...
	@Override
	public ModelAndView updateDitailOrderUpdatePage(List<DetailPageInfo> detailPages) throws Exception {
		// TODO Auto-generated method stub
		...
		try{
			...
			LOGGER.error("updateDitailOrderUpdatePage error:" + e.toString());
			model.addObject(Globals.STATUS, Globals.STATUS_FAIL);
...
//				boolean musicPOPChk = false;
				...
				//IMAP 으로 변경
				List<Map<String, Object>>  detailList = detailMapper.selectDetailPageInfoManageListByContent(search);
				JSONArray jsonA = JSONArray.fromObject(detailList);	
				
				search = null;
				
				mediaType= detailList.get(0).get("mediatype").toString();
				if(mediaType == null){
//					musicPOPChk = true;
				} else {
